...
namespace Array_Manipulator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((input = Console.ReadLine()) != "end")
            {
                ...
                else if (command[0] == "first")
                {
                    ...
                    if (command[2] == "even")
                    {
                        ReturnFirsEven(arr, count);
                    }
                    else
                    {
                        ReturnFirsOdd(arr, count);
                    }
                }
        ...
        {
            int[] firsArray = new int[array.Length - index -1];
            int[] secondArray = new int[index + 1];

            int firstArrayCounter = 0;
            for (int i = index +1; i < array.Length; i++)
            {
                firsArray[firstArrayCounter] = array[i];
                firstArrayCounter++;
            }
            ...
            {
                array[firsArray.Length + i] = secondArray[i];
            }
        }
        ...
        static void ReturnFirsEven(int[] array,int count)
        {
        ...
        static void ReturnFirsOdd(int[] array, int count)
        {
            string numbers = string.Empty;
            int couter = 0;
